			...
			<div class="footer-wrapper">
				<div class="row">
					...
					<div class="col-md-2 col-sm-3 footer-col">
						<div class="footer-title"><?php echo get_page_full_link('contact-us', 'Contact', 'page', !is_front_page() ? '' : ''); ?></div>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-2 col-sm-3 col-xs-6 footerMarginBottom">
						<div class="copyright-text">
							<?php echo get_page_full_link('privacy-policy', 'Privacy Policy', 'page', !is_front_page() ? '' : ''); ?>
						</div>
					</div>
					<div class="col-md-2 col-sm-3 col-xs-6 footerMarginBottom">
						<div class="copyright-text">
							<?php echo get_page_full_link('cookies-policy', 'Cookies Policy', 'page', !is_front_page() ? '' : ''); ?>
						</div>
					</div>
					<div class="col-md-2 col-sm-3 col-xs-6 footerMarginBottom">
						<div class="copyright-text">
							<?php echo get_page_full_link('credits', 'Credits', 'page', !is_front_page() ? '' : ''); ?>
						</div>
					</div>
...
<script>
	window.addEventListener('load', function() {
		$('.banner').each(function() {
			var l = $(this);
			l.css('background-image', 'url("' + l.attr('data-src') + '")');
			l.find('img.spinner').remove();
		});
	});
</script>
<script>
	window.addEventListener('load', function() {
		if ($('.col-extra').length) $('.col-extra').matchHeight();
	});
</script>
<script>
